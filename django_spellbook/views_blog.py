...
def view_first_post(request):
    ...
    context['parent_directory_url'] = 'blog:blog_directory_index_root_blog'
...
def directory_index_root_blog(request):
    ...
    'directory_stats': {
        ...
        'directory_path': '',
        'url_pattern': '/',
        'view_name': 'directory_index_root_blog',
        'namespace': 'blog',
    },
    'is_directory_index': True,
}
    context['toc'] = TOC
    context['current_url'] = 'blog:blog_directory_index_root_blog'
