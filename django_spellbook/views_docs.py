...
def view_intro(request):
    ...
    context['parent_directory_url'] = 'docs:docs_directory_index_root_docs'
...
def directory_index_root_docs(request):
    ...
    'directory_stats': {
        ...
        'directory_path': '',
        'url_pattern': '/',
        'view_name': 'directory_index_root_docs',
        'namespace': 'docs',
    },
    'is_directory_index': True,
}
    context['toc'] = TOC
    context['current_url'] = 'docs:docs_directory_index_root_docs'
